      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-12">
        <div className="space-y-2 mb-16">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs font-black uppercase tracking-widest text-primary">Navegue por Categoria</span>
          </div>
          <h2 className="text-4xl font-black tracking-tighter uppercase">Categorias em Destaque</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {categories.map((category) => (
            <Link
              ...
              className="group relative overflow-hidden rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:scale-105 cursor-pointer"
              style={{
